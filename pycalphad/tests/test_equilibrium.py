...
def test_crtiv_ternary_three_phase_dilute(load_database):
    """Test equilibrium is correct for a ternary three phase equilibrium where one phase is dilute"""
    dbf = load_database()
    ...
    eq_res = equilibrium(dbf, components, phases, {v.X("CR"): 0.20, v.X("TI"): 0.20, **conditions}, verbose=True, to_xarray=False)
    print(eq_res.Phase)
